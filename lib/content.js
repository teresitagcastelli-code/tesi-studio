    ...
    series: [
      {
        ...
        eyebrow: "Serie · 01",
        title:  "Miniaturas",
        lede:   "Para mí lo precioso vive en lo pequeño, y lo íntimo en lo que se guarda. Cada miniatura encierra un secreto en un círculo mínimo: no para esconderlo, sino para volverlo protagonista, una opulencia que brilla en voz baja.",
        pieces: [
          { id: "min-01", image: "/assets/obra/miniaturas/min-01.jpg", title: "San", year: "2026", materials: "viscosa, hilo de algodón, seda, alambre, plástico, vidrio, hoja de oro y acrílico", dims: "80 × 60 × 3 cm", desc: "«La fascinación más profunda consiste en encerrar el objeto individual en un círculo mágico». Walter Benjamin, Libro de los Pasajes." },
        ],
      },
      {
        id:     "ventana",
        ...
        pieces: [
          { id: "ven-01", image: "/assets/obra/ventana/ven-01.jpg", title: "Ventana de un recuerdo claro", year: "2023", materials: "chenille, hilo de algodón, plástico, vidrio", dims: "45 × 60 × 5 cm (enmarcada)", desc: "El refugio de un alma podría ser siempre la infancia." },
        ],
      },
    ],
    about: {
    ...
    series: [
      {
        ...
        lede: "For me, the precious lives in the small, and the intimate in what is kept. Each miniature encloses a secret within a minimal circle: not to hide it, but to make it the protagonist, an opulence that shines in a low voice.",
        pieces: [
          { id: "min-01", image: "/assets/obra/miniaturas/min-01.jpg", title: "San", year: "2026", materials: "viscose, cotton thread, silk, wire, plastic, glass, gold leaf and acrylic", dims: "80 × 60 × 3 cm", desc: "«The deepest fascination consists in enclosing the individual object within a magic circle». Walter Benjamin, The Arcades Project." },
        ],
      },
      {
        ...
        pieces: [
          { id: "ven-01", image: "/assets/obra/ventana/ven-01.jpg", title: "Window of a Clear Memory", year: "2023", materials: "chenille, cotton thread, plastic, glass", dims: "45 × 60 × 5 cm (framed)", desc: "The refuge of a soul could always be childhood." },
        ],
      },
    ],
    about: {
